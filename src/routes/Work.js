  ...
  return (
    <section className="Work">
      ...
      <div className="container my-4 mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 ">
        ...
        {/* block start */}
        <div className="relative rounded border border-gray-300 p-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <a className="mt-2 rounded-full p-2 no-underline hover:bg-gradient-to-r from-purple-900 via-white to-gray-700" href="https://github.com/seth20smith/weather-dashboard-wk-6"> Source Code:
        ...
        <div className="relative rounded border border-gray-300 p-4">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500" href="https://github.com/seth20smith/typical9to5"> Source Code:
        ...
        <div className="relative rounded border border-gray-300 p-4">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/note_taker">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black" />
          </a>
        </div>

        {/* Box 4 */}
        <div className="relative rounded border border-gray-300 p-10">
          <a href="https://seth20smith.github.io/PasswordGen/" className="block">
            ...
            <div className="flex flex-col items-center"></div>
            <img src="./images/Password Gen.png" alt="Password Generator" className="h-90 w-90 object-contain" />
          </a>
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/PasswordGen">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black " />
          </a>
        </div>
        ...
        <div className="relative rounded border border-gray-300 p-10">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/week4codequiz">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black" />
          </a>
        </div>
        ...
        <div className="relative rounded border border-gray-300 p-4">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/Programming-Challenge-10">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black" />
          </a>
        </div>
        ...
        <div className="relative rounded border border-gray-300 p-10">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/day-trip-planner">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black" />
          </a>
        </div>
        ...
        <div className="relative rounded border border-gray-300 p-10">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/eCom_backEnd_13">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black" />
          </a>
        </div>
        ...
        <div className="relative rounded border border-gray-300 p-10">
          ...
          <a className="absolute hover:bg-gradient-to-r from-purple-900 via-white to-gray-700 bottom-2 left-1/2 transform -translate-x-1/2 rounded-full p-2 no-underline hover:bg-blue-500 " href="https://github.com/seth20smith/Employee_database_12">Source Code:
            <FontAwesomeIcon icon={faGithub} className="h-6 w-6 text-black" />
          </a>
        </div>
      </div>
