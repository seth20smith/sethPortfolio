...
const SocialButton = ({ href, logoSrc, altText, buttonText, logoSize }) => (
  <div className="md:w-96 rounded shadow-lg p-5 bg-gradient-to-r from-gray-600 via-gray-300 to-purple-900 m-4 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
